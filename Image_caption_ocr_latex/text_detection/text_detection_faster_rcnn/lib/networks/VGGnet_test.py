...
# Last Modified time: 2018年05月03日10:44:43
import os
import sys
...
class VGGnet_test(Network):
    ...
    def setup(self):
        ...
        (self.feed('rpn_cls_score').spatial_reshape_layer(2, name='rpn_cls_score_reshape')
        ...
        self.feed('rpn_cls_prob_reshape', 'rpn_bbox_pred', 'im_info').proposal_layer(
            _feat_stride, anchor_scales, 'TRAIN', name='rois')
