...
class SSDNet(object):
    ...
    default_params = SSDParams(
        img_shape=(300, 300),
        num_classes=21,#     20类+1背景
        no_annotation_label=21,
        # get feature map layers
        feat_layers=['block4', 'block7', 'block8', 'block9', 'block10', 'block11'],
        feat_shapes=[(38, 38), (19, 19), (10, 10), (5, 5), (3, 3), (1, 1)],   # the size of feature map in every layer
        # （每一层feature map中的anchor box的大小）
        # 计算方法为sk==s_min+(s_max-s_min)*(k-1)/(m-1) k∈[1,m]
        # m--nums of feature maps;
        # s_min=anchor_size_bounds[0];
        # s_max=anchor_size_bounds[1]
        anchor_size_bounds=[0.15, 0.90],
        # anchor_size_bounds=[0.20, 0.90],
        # anchor box的大小 通过上述方法计算所得
        # m=6 sk=[0.15, 0.3, 0.44999999999999996, 0.6, 0.75, 0.9]
        # r∈{1,2,3,1/2,1/3}
        # w= sk*r**0.5 h=sk/r**0.5
        anchor_sizes=[(21., 45.),
                      (45., 99.),
                      (99., 153.),
                      (153., 207.),
